...
import { ProductIntakeTurnDto } from './dto/product-intake-turn.dto.js';
import { ProductIntakeTurnService } from './product-intake-turn.service.js';

@Controller()
@UseGuards(JwtAuthGuard, PermissionsGuard)
export class ProductIntakeController {
  constructor(private readonly turns: ProductIntakeTurnService) {}

  @Post('projects/:projectId/intake/product/turn')
  @RequirePermission(Permission.AGENT_EXECUTE)
  turn(
    @CurrentUser() auth: AuthContext,
    @Param('projectId') projectId: string,
    @Body() dto: ProductIntakeTurnDto,
