...
export function ManualPublishCardV5({
  ...
  return (
    <section className="space-y-3 rounded-xl border border-[var(--acf-border)] bg-[var(--acf-surface)] p-4" data-acf-manual-publish-card-v5>
      ...
      <p className="text-sm text-neutral-600">下一步：下载视频，在抖音手动发布，再回来点「我已经发布」登记作品。</p>
